...
--   - enforces 150 character limit on message text
...
create table public.motivational_messages (
  ...
  message_text text not null check(length(message_text) <= 150),
...
comment on column public.motivational_messages.message_text is 'ai-generated motivational message content (max 150 characters)';
